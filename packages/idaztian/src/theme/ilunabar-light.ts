...
/**
 * Ilunabar Light Theme — Default light theme for Idaztian.
 */
...
export const ilunabarLightTheme = EditorView.theme(
    {
        '&': {
            color: colors.text,
        ...
        '.idz-math-block:hover': {
            borderColor: colors.border,
        },
        '.idz-math-block::after': {
            content: "'</>'",
            position: 'absolute',
            top: '8px',
            right: '8px',
        ...
        '.idz-math-active': {
            backgroundColor: 'rgba(127, 109, 242, 0.15)',
            borderRadius: '2px',
            padding: '2px 0',
...
export function ilunabarLight() {
    return [ilunabarLightTheme, ilunabarHighlightStyle];
}
